...
function applyConfig(){
  ...
  if(APP_CONFIG.ui && APP_CONFIG.ui.preventTextSelection){
    document.documentElement.classList.add("no-select-mode");
  }
  else{
    document.documentElement.classList.remove("no-select-mode");
  }
}
